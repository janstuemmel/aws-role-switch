  ...
  switch (key) {
    ...
    case 'key':
      return [
        ...
        {
          label: 'target_role_name',
          apply: 'target_role_name = ',
          type: 'keyword',
        },
...
export const showCompletionForCompletedKey = EditorView.updateListener.of(
  ({state, view, docChanged}) => {
